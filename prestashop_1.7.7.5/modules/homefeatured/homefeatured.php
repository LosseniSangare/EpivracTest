...
class homefeatured extends Module
{
    public function __construct()
    {
        ...
        $this->mypresta_link = "https://mypresta.eu/modules/front-office-features/homepage-tab-popular-products.html";
            ...
            if (defined('_PS_ADMIN_DIR_')) {
                ...
                if (Configuration::get('mypresta_updates') != 0 || (bool)Configuration::get('mypresta_updates') != false) {
                    if (Configuration::get('update_' . $this->name) < (date("U") - 259200)) {
                        $actual_version = homefeaturedUpdate::verify($this->name, (isset($this->mkey) ? $this->mkey : 'nokey'), $this->version);
                    }
                    if (homefeaturedUpdate::version($this->version) < homefeaturedUpdate::version(Configuration::get('updatev_' . $this->name))) {
                ...
                if ($display_msg == 1) {
                    if (homefeaturedUpdate::version($this->version) < homefeaturedUpdate::version(homefeaturedUpdate::verify($this->name, (isset($this->mkey) ? $this->mkey : 'nokey'), $this->version))) {
...
class homefeaturedUpdate extends homefeatured
{
